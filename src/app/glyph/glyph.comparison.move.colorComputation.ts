...
/**
 * This class is used to compute the colors of lines for
 * the move visualization concept.
 * Different variants were tested before the final version was found.
 * These former implementations are kept in this code.
 */
export class ColorComputation {
  ...
  // statics ///////////////////////////////////////////
    ...
    public static stcCstr = (() => {
      // making a diverging scale of two sequential scales
    ...
    // data set characteristics are changed
    private _onChanged: () => void = null;

 /**
  * initializing of data set characteristics of values which are 
  * mapped to color
  ...
  */
  ...
  // Variant I /////////////////////////////////////////////////
 /**
  * color computation variant I
  * computes heat from value considering mean and max and maps this to a color.
  */
  public computeColorI( value: number): [number, number, number] {
  ...
  public map( heat: number): [number, number, number] {
   ...
   // Variant II /////////////////////////////////////////////////
    ...
    // tested variant II color computation
  ...
  /**
   * get message whendata set characteristics are changed
   */
